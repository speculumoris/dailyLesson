...
public class Deque01 {
    ...
    public static void main(String[] args) {
        ...
        /*
        Kapasite kısıtlamalarını ihlal etmeden hemen yapmak mümkünse, bu deque tarafından temsil edilen yığına (başka bir deyişle, bu deque'nin başında) bir öğeyi iter,
         şu anda boş alan yoksa bir IllegalStateException fırlatır.Bu yöntem, addFirst'e eşdeğerdir.
         */
