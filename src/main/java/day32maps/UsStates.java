...
public enum UsStates {
    ...
    public static String getStateNameFromAbbreviation(String abbreviaton) {
        return Arrays.stream(values()).filter(UsStates -> UsStates.getAbbreviation().equals(abbreviaton)).findFirst().get().getStateName();
    ...
    //Example 1: Baskenti verilen state'in kisaltmasini ekrana yazdiran methodu olusturun
    public static String getStateAbbrFromCapital(String capital){
